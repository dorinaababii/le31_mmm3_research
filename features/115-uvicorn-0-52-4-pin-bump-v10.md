# Feature 115 — uvicorn 0.52.4 pin-bump v10

> **NEW observation (2026-08-26).** Documents the in-window
> `uvicorn 0.52.4` pin-bump surface from the 2026-08-26 daily
> research pass — the 10th consecutive day the same pin-bump has
> surfaced (carry-over of features 27, 70, 76, 78, 80, 82, 87, 93, 99, 105, 109).
> The burst has now stabilized at 0.52.4 for 7 consecutive days
...
build candidate now that the burst has stabilized for 7 days. The
...
the WebSocket close-handshake fix in. The 7-day stable plateau at
...
- The 7-day stable plateau at 0.52.4 (carry-over from prior pass; now
  7 days stable as of 2026-08-26) confirms the burst has stabilized.
- No 0.52.5 release in 168h.
...
3. **The 7-day stable plateau is the right time to ship.** If the
...
4. **No 0.52.5 release is imminent.** The burst has stabilized at
   ...
   changes; the rest is performance/profit.
...
| 99 `uvicorn-0-52-4-pin-bump-v8` | uvicorn 0.52.4 pin (carry-over, day 8, 2026-08-23) | Older target |
| 105 `uvicorn-0-52-4-pin-bump-v8` | uvicorn 0.52.4 pin (canonical day-8 artifact, 2026-08-24) | Older target |
| 109 `uvicorn-0-52-4-pin-bump-v9` | uvicorn 0.52.4 pin (canonical day-9 artifact, 2026-08-25) | Older target |
| **115 `uvicorn-0-52-4-pin-bump-v10` (this)** | uvicorn 0.52.4 pin (carry-over, day 10, this cron) | Same target; **newest** artifact |

This pick is the **10th consecutive daily-research carry-over** of
the same uvicorn 0.52.4 pin-bump. It is NOT a duplicate of the prior
v7/v8/v9 artifacts — it is the **newest** daily-research observation
that the burst has now stabilized at 0.52.4 for 7 consecutive days
with no 0.52.5 release.
...
close-handshake fix + bodyless request handling + HTTP/1.1 request
parsing performance). The 7-day stable plateau at 0.52.4 (no 0.52.5
