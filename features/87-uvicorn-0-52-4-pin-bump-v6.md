# Feature 87 — uvicorn 0.52.4 pin-bump (v6)

> **Carry-over from 2026-08-16 (feature 70) → 2026-08-17 (feature 76) → 2026-08-18 (feature 78) → 2026-08-19 (feature 80) → 2026-08-20 (feature 82) → 2026-08-21 (this feature, v6).**
> Supersedes `features/82-uvicorn-0-52-4-pin-bump-v5.md`.
...
- The v0.52.5 bump if it lands (re-check on 2026-08-22 — none observed
  today; burst has stabilized at 0.52.4 for 3 consecutive days).
...
and has now stabilized at 0.52.4 for 3 consecutive days with no 0.52.5
yet.
...
1. Edit the dependency manifest to change `uvicorn == 0.52.1` to
   ...
   bumped per feature 80/82). The exact starting pin depends on which
...
3. Append a row to `/opt/data/INDEX.md` "Active feature pipeline"
   table with date 2026-08-21, pick slug `uvicorn-0-52-4-pin-bump-v6`,
   feature path `features/87-uvicorn-0-52-4-pin-bump-v6.md`, and the
...
- Has the team already applied feature 80 (2026-08-19, v4) or feature 82
  (2026-08-20, v5)? The exact starting pin depends on this. If neither
  was applied, the starting pin is `uvicorn == 0.52.1`. If v5 was
  applied, the starting pin is already `uvicorn == 0.52.4` and this
  artifact is a no-op.
...
after 72h with no 0.52.5 release. If the team is doing a pin-bump
