# uvicorn-0-52-4-pin-bump-v10 — HANDOFF

> **Slice for the coding agent.** Read this *and*
> `features/115-uvicorn-0-52-4-pin-bump-v10.md` before touching any
> code. Do not paste chat excerpts back into the build.

## Frozen identifiers (do not rename)

- Feature ID: `115`
- Slug: `uvicorn-0-52-4-pin-bump-v10`
- Contract file: `features/115-uvicorn-0-52-4-pin-bump-v10.md`
...
- Linear sub-issue: **HMM-152** (Feature)

## LE31 feature-gate verdict (recorded)

Run per `skills/le31-conventions/SKILL.md`. Evidence precondition:
**observed** (verified in-window across the 27-pass series via two
...
0.52.4 with no 0.52.5 release in 7 days).
...
the burst has stabilized at 0.52.4 after 7 days with no 0.52.5
release).
...
This slice is the 10th carry-over of the same pin-bump target:
...
| 109 | day 9 | 2026-08-25 | uvicorn 0.52.4 pin |
| **115** | **day 10** | **2026-08-26** | **uvicorn 0.52.4 pin (this artifact)** |

The pin target (0.52.4) and the protocol (single-line manifest bump)
have been stable across 7 days of observation; this slice captures
...
Before coding, mirror back: slice ID (`115`), required skills
